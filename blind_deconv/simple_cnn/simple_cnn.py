...
accuracy = tf.div(tf.sqrt(tf.mul(tf.reduce_mean(tf.nn.l2_loss(tf.sub(pred, y))), 2.0)), batch_size)
    ...
    while step * batch_size < training_iters:
        ...
        if step % display_step == 0:
            ...
            for i in xrange(batch_size):
                ...
                arr.save('/Users/vaibhavg/Desktop/Stanford/AI/Project/Dataset/training/output/foo'+str(i)+".jpeg")
